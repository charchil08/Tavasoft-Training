using CommunityInvestment.Model.Models;
using Microsoft.EntityFrameworkCore;

namespace CommunityInvestment.Model.Data
{
    public partial class CommunityInvestmentContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Admin>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email, "UQ__admin__AB6E6164E951E75B")
                    .IsUnique();
            ...
            modelBuilder.Entity<Country>(entity =>
            {
                ...
                entity.HasIndex(e => e.Name, "uk_countryName")
                    .IsUnique();
            ...
            modelBuilder.Entity<MissionMedium>(entity =>
            {
                entity.HasKey(e => e.MissionMediaId)
                    .HasName("PK__mission___848A78E8BDC2461B");
            ...
            modelBuilder.Entity<StoryMedium>(entity =>
            {
                entity.HasKey(e => e.StoryMediaId)
                    .HasName("PK__story_me__29BD053C0A278805");
